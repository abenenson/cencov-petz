import CencovPetz.PermutationInvariance
...
-- `Pi.single` basis vectors on `Fin n`.
...
@[simp] lemma κ_tangentPushforward_apply (σ : Equiv.Perm (Fin n)) (u : V n) (k : Fin n) :
...
@[simp] lemma κ_pushforward_apply (σ : Equiv.Perm (Fin n)) (p : Simplex (Fin n)) (k : Fin n) :
